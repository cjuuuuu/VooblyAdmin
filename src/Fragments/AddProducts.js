...
class AddProducts extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      ["1_star"]: { error: "", value: "0" },
      ["2_star"]: { error: "", value: "0" },
      ["3_star"]: { error: "", value: "0" },
      ["4_star"]: { error: "", value: "0" },
      ["5_star"]: { error: "", value: "0" },
  ...
  uploadProducts = (e) => {
    ...
    this.uploadImages(this.state.images, index, urls, () => {
      let data = {
        ...
        [" max-quantity"]: parseInt(this.state.max_quantity.value),
        offers_applied: parseInt(this.state.offer_applied.value),
